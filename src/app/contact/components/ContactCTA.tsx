...
export default function ContactCTA() {
  return (
    <section className="py-16 bg-[#b8873d] text-white text-center font-poppins">
      <h2 className="text-3xl font-bold mb-6 mt-10 font-montserrat">Let&apos;s <span className="text-[#2e318e]">Connect</span></h2>
      <p className="mb-8 max-w-2xl mx-auto">
        Whether you have questions, partnership ideas, or need support, our team
        is here to help. Get in touch today.
      </p>
      <button className="relative overflow-hidden group px-15 py-3 rounded-lg bg-[#b8873d] border border-[#ffffff] text-[#ffffff] hover:text-[#2e318e] font-bold font-montserrat transition-all ease-in-out duration-500">
