export default function CTASection() {
  return (
    <section className="py-12 px-6 md:px-12 bg-[#b8873d] text-white text-center font-poppins">
      <h2 className="text-3xl font-bold mb-6 font-michroma tracking-wide">
      ...
      <button className="relative overflow-hidden group px-15 py-3 rounded-lg bg-[#b8873d] border border-[#ffffff] text-[#ffffff] hover:text-[#2e318e] cursor-pointer font-bold font-michroma transition-all ease-in-out duration-500">
